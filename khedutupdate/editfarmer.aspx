<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="editfarmer.aspx.cs" Inherits="khedutupdate.WebForm10" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="container">
    <h1 class="well">એડિટ પ્રોફાઇલ</h1>
	...
	<div class="row">
			...
			--%>		
				...
				<%--	<div class="form-group">
					...
					<div class="form-group">
						<label>ઇમેઇલ</label>
						<%--<input type="text" placeholder="ઇમેઇલ દાખલ કરો" class="form-control">
		--%>			
        ...
        <div class="row">
					...
					--%>	
                                  <asp:TextBox ID="cpassword" runat="server" class="form-control" Placeholder="અનુરૂપ પાસવર્ડ દાખલ કરો"></asp:TextBox>
